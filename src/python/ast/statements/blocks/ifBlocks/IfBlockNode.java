...
public class IfBlockNode extends StatementNode {
	 ...
	 * @author C.Silva, R.Cuinat
	 */
	public IfBlockNode(int line, int column) {
		super(line, column);
	}

	/**
	 * Sets the condition of the if block with the specified expression.
	 ...
	 * @return The body of the if block.
	 * @author C.Silva, R.Cuinat
	 */
